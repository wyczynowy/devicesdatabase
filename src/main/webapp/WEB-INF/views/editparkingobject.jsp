...
<head>
	...
	<title>Editing parking object</title>
</head>
<body>

	<div class="horizontal-center" style="width: 10%; min-width:235px; top: 20; margin: 0 auto;">
		<h1><span class="label label-default">Edycja obiektu</span></h1>
	</div>
	
	<div style="width: 50%; height: 100vh; margin: 0 auto;">
		<div style="height: 10%; min-height: 550px; margin-top: 10%;">
			<form:form action="${pageContext.request.contextPath}/manageparkings/updatefilledparkingobjectform?id=${parkingObject.id}" modelAttribute="parkingObject" method="post">
